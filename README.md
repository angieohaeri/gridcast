...
![system_architecture](/references/images/bikeshare_system_architecture.svg)
...
│                         bikeshare and configuration for tools like black
│
...
│
└── bikeshare   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes bikeshare a Python module
    │
